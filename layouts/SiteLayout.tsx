  ...
  return (
    <>
      <div className="md:flex">
        <div className="md:flex-shrink-0 md:flex-grow-0 md:basis-auto shadow-lg md:bg-shadebg-light dark:md:bg-shadebg-dark md:shadow-2xl dark:shadow-shadeshadow-dark shadow-shadeshadow-light">
          <SiteHeader />
        </div>

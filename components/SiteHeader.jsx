...
const SiteHeader = ({ className = '' }) => {
  ...
  return (
    <header
      className={`noprint relative ml-0 mb-4 flex h-[4.5rem] items-center border-b-2 border-border pl-4 md:sticky md:top-0 md:ml-0 md:mr-4 md:w-[12rem] md:flex-col md:border-b-0 md:pl-0 ${className}`}
    >
      <figure title='steinkamp.us' className=''>
        <div className='absolute top-0 left-[-1rem] mr-2 hidden w-12 md:top-[-6.0rem] md:left-0 md:mr-0 md:block md:w-[13rem]'>
          <Mono />
        </div>

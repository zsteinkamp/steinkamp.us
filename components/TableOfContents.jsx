function TableOfContents({ headings, className = '' }) {
  return (
    <div
      className={`TableOfContents mt-0 block text-sm lg:float-right lg:pl-8 lg:[max-width:var(--toc-width)] 2xl:fixed 2xl:left-[66rem] 2xl:float-none 2xl:max-w-xs ${className}`}
    >

  ...
  return (
    <ul className={className}>
      {posts.map((post) => (
        <li
          key={post.slug}
          className='rounded-xl hover:bg-shadebg-light hover:shadow-lg hover:shadow-shadeshadow-light dark:hover:bg-shadebg-dark hover:dark:shadow-shadeshadow-dark md:mb-4'
        >

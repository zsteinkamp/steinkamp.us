  ...
  const buttonIcon = () => {
    if (theme === THEME_DARK) {
      return (
        <svg
          ...
          height='24'
          viewBox='0 0 24 24'
          className='fill-themetoggle opacity-80 hover:fill-themetoggle-hover hover:opacity-100'
        >
          <path
            className=''
    ...
    return (
      <svg
        ...
        height='24'
        viewBox='0 0 24 24'
        className='fill-themetoggle opacity-100 hover:fill-themetoggle-hover hover:opacity-100'
      >
